...
const TabList = () => {
  ...
  const { hasStartScrollButton, hasEndScrollButton, handleMoveScroll } =
    useTabListScroll(tabList);
  ...
  return (
    <Layout>
      {hasStartScrollButton && (
        <TabListScrollButton
          position="left"
          moveScroll={() => handleMoveScroll('start')}
        />
      )}
      ...
      {hasEndScrollButton && (
        <TabListScrollButton
          position="right"
          moveScroll={() => handleMoveScroll('end')}
        />
      )}
    </Layout>
  );
